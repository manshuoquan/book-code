...
void GameAbout::onEnter(){
    ...
    mainmenu->runAction(CCSequence::create(CCEaseElasticIn::create(CCMoveBy::create(0.5,ccp(100,0))),CCCallFunc::create(this, callfunc_selector(GameAbout::menuEnter)),NULL));
    //加速度动作
