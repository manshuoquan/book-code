...
void GameHeroBullet::setIsVisable(){
    ...
    isvisable = true;
    this->runAction(CCSequence::create(CCMoveTo::create((-this->getPosition().y + 550)/150,ccp(this->getPosition().x,550)),CCCallFunc::create(this, callfunc_selector(GameHeroBullet::setIsNotVisable)),NULL));;
}
