...
void GameMenu::onEnter(){
    ...
    mainmenu->runAction(CCSequence::create(CCEaseElasticIn::create(CCMoveTo::create(0.5,ccp(0,0))),CCCallFunc::create(this, callfunc_selector(GameMenu::menuEnter)),NULL));
